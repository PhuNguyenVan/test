 ...
 * @author   WooThemes
 */
class WC_Campaign_Data_Store_CPT extends WC_Data_Campaign_Store_WP implements WC_Campaign_Data_Store_Interface, WC_Object_Campaign_Data_Store_Interface {
	...
	public function read( &$coupon ) {
		...
		if ( ! $coupon->get_id() || ! ( $post_object = get_post( $coupon->get_id() ) ) || 'shop_campaign' !== $post_object->post_type ) {
